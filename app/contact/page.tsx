        ...
        <div className="pt-24 pb-20 min-h-screen">
              <div className="max-w-6xl mx-auto px-4">
                      <div className="text-center mb-12">
                                <h1 className="text-4xl font-bold text-gray-900 mb-3">Get In Touch</h1>h1>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        {/* Form */}
                                <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm">
                                            <form onSubmit={handleSubmit} className="space-y-5">
                                                          <div>
                                                                          <label className="block text-sm font-medium text-gray-700 mb-1.5">I&apos;m interested in</label>label>
                              ...
                              <button
                                ...
                                {opt}
                                                          ...
                                                          <div>
                                                                          <label className="block text-sm font-medium text-gray-700 mb-1.5">Full Name</label>label>
                                                                          <input
                                                                                              type="text"
                                                                                              required
                                                                                              value={formData.name}
                                                          ...
                                                          <div>
                                                                          <label className="block text-sm font-medium text-gray-700 mb-1.5">Message</label>label>
                                                                          <textarea
                                                                                              rows={4}
                        ...
                        {/* Contact Info */}
                                <div className="space-y-8">
                                            <div>
                                                          <h3 className="text-lg font-bold text-gray-900 mb-4">Contact Information</h3>h3>
                                                          <div className="space-y-4">
                                                                          <div className="flex items-start gap-4">
                                                                                            ...
                                                                                            <div>
                                                                                                                <div className="font-medium text-gray-900">(757) 777-7577</div>div>
                                                                                                                <div className="text-sm text-gray-500">Call or text anytime</div>div>
                                                                                              </div>div>
                                                                          </div>div>
                                                                          ...
                                                                          <div className="flex items-start gap-4">
                                                                                            ...
                                                                                            <div>
                                                                                                                <div className="font-medium text-gray-900">tom@vahome.com</div>div>
                                                                                                                <div className="text-sm text-gray-500">We reply within 24 hours</div>div>
                                                                                              </div>div>
                                                                          </div>div>
                                                                          ...
                                                                          <div className="flex items-start gap-4">
                                                                                            ...
                                                                                            <div>
                                                                                                                <div className="font-medium text-gray-900">249 Central Park Ave Ste 300</div>div>
                                                                                                                <div className="text-sm text-gray-500">Virginia Beach, VA 23462</div>div>
                                                                                              </div>div>
                                                                          </div>div>
                                                          </div>div>
                                            </div>div>
                                  ...
                                  {/* Map placeholder */}
                                            <div className="aspect-[4/3] bg-gray-100 rounded-2xl flex items-center justify-center">
                                                          <span className="text-gray-400 text-sm">Google Map Embed</span>span>
                                            </div>div>
                                </div>div>
                      </div>div>
              </div>div>
