      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <section className="max-w-4xl mx-auto px-6 py-8">
            <p className="text-gray-700 leading-relaxed text-base">{`We respond to most inquiries within an hour during business hours and the same day on evenings and weekends. The fastest way to reach us is through the form below or by texting (757) 777-7577. Whether you want a no-pressure home valuation estimate, a tour of a specific listing, help understanding VA loan eligibility, or just a market overview for a Hampton Roads neighborhood, the VaHome team is happy to help. We work with first-time buyers, military families on PCS orders, longtime Virginia residents, investors, and out-of-state relocators. There's never any obligation to a follow-up conversation â our goal is to be a useful resource even if you're months away from buying or selling.`}</p>
          </section>
