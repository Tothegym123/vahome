...
const CATEGORY_INTROS: Record<string, string> = {
  ...
  "hampton-roads": "Hampton Roads is one of America's most distinctive real estate regions, combining seven cities â— Virginia Beach, Norfolk, Chesapeake, Suffolk, Hampton, Newport News, and Portsmouth â— with the surrounding counties of York, James City, and Gloucester. This category covers regional topics that span multiple cities, including commute analysis, school district comparisons, military base proximity, area economic trends, and what makes each Hampton Roads submarket unique. The VaHome team works across the entire region.",
