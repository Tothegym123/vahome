...
const priceOptions = [
  ...
  { label: '$300KÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ$500K', min: 300000, max: 500000 },
  { label: '$500KÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ$750K', min: 500000, max: 750000 },
  ...
  useEffect(() => {
    ...
    const initMap = async () => {
      ...
      map.on('load', () => {
        ...
        // ---- Click listing ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ show popup card (Zillow style) ----
          ...
          const html = `
            <a href="${props.url}" class="popup-card" style="display:block;text-decoration:none;color:inherit;width:240px;cursor:pointer;font-family:-apple-system,BlinkMacSystemFont,sans-serif;">
              ...
              <div style="padding:10px 12px 12px;">
                ...
                <div style="font-size:11px;color:#ef4444;font-weight:600;margin-top:6px;">View details ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ</div>
              </div>
            </a>
          `
        ...
        // Update visible listings on map move ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ using 'idle' instead of 'moveend'
      ...
      //       // ---- Video markers (HTML markers ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ only 5, so DOM is fine) ----
