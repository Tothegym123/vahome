  ...
  useEffect(() => {
    ...
    ;(async () => {
      ...
      const rasterStyle: any = {
        ...
        sources: {
          'osm-raster': {
            ...
            tileSize: 256,
            attribution: '&copy; OpenStreetMap ÃÂÃÂ© CARTO',
          },
        },
        layers: [
          {
      ...
      const renderMarkers = (items: Listing[]) => {
        ...
        // Military bases overlay (SVG ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ vector layers broken in v3)
                ...
                <div className="flex gap-3 p-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-gray-700 mt-1">
                      {l.beds} bd ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ {l.baths} ba ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ {l.sqft.toLocaleString()} sqft
                    </div>
                  </div>
                </div>
              </button>
            ...
            <Link href={getListingUrl(selected)} className="block hover:bg-gray-50 transition-colors cursor-pointer">
              ...
              <div className="p-4">
                ...
                <div className="text-sm text-gray-800 mb-3">
                  {selected.beds} bd ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ {selected.baths} ba
                  {selected.halfBaths ? ` ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ ${selected.halfBaths} half` : ''} ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ {selected.sqft.toLocaleString()} sqft
                </div>
