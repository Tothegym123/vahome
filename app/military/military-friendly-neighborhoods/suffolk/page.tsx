...
const articleSchema = { "@context": "https://schema.org", "@type": "Article", headline: "Military-Friendly Neighborhoods in Suffolk, VA", description: "Detailed guide to Suffolk neighborhoods for military families with school + commute context.", datePublished: "2026-04-29", dateModified: "2026-04-29", author: { "@type": "Person", name: "Tom Milan", jobTitle: "Realtor" }, publisher: { "@type": "Organization", name: "VaHome" }, mainEntityOfPage: "https://vahome.com/military/military-friendly-neighborhoods/suffolk/" };
const breadcrumbSchema = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
  ...
  { "@type": "ListItem", position: 4, name: "Suffolk", item: "https://vahome.com/military/military-friendly-neighborhoods/suffolk/" },
] };
