...
export const metadata: Metadata = {
  title: "O-4 BAH Norfolk MHA (2026): $3,054/mo with Dependents | VaHome",
  description:
    "2026 verified BAH rate for O-4 with dependents in the Norfolk Military Housing Area: $3,054/mo. See max home price, top neighborhoods, and how to use it with a VA loan.",
  alternates: { canonical: "https://www.vahome.com/military/bah/o-4/norfolk-mha/" },
  openGraph: { title: "O-4 BAH Norfolk MHA (2026)", description: "$3,054/mo with dependents. Max home price ~$489,000.", url: "https://www.vahome.com/military/bah/o-4/norfolk-mha/", type: "article" },
};

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "O-4 BAH in the Norfolk MHA (2026)",
  description: "Verified 2026 BAH rate for O-4 with dependents in Norfolk MHA, with affordability math and Hampton Roads home recommendations.",
  datePublished: "2026-04-29",
  dateModified: "2026-04-29",
  author: { "@type": "Person", name: "Tom Milan", jobTitle: "Realtor" },
  publisher: { "@type": "Organization", name: "VaHome" },
  mainEntityOfPage: "https://www.vahome.com/military/bah/o-4/norfolk-mha/",
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "O-4", item: "https://www.vahome.com/military/bah/o-4/" },
    { "@type": "ListItem", position: 5, name: "Norfolk MHA", item: "https://www.vahome.com/military/bah/o-4/norfolk-mha/" },
  ],
};

export default function BAHPageO4() {
  return (
    <main className="bg-white">
      ...
      <section className="bg-gradient-to-br from-slate-900 via-blue-950 to-blue-900 text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          <nav className="text-xs text-blue-200 mb-4">
            ...
            <span className="mx-2">/</span>
            <span className="text-white">O-4 - Norfolk MHA</span>
          </nav>
          <h1 className="text-3xl sm:text-5xl font-bold leading-tight">O-4 BAH in the Norfolk MHA (2026)</h1>
          <p className="mt-4 text-lg sm:text-xl text-blue-100 max-w-3xl">
            Official 2026 BAH for O-4 with dependents in the Norfolk Military Housing Area. Plus the max home price this rate supports on a VA loan and the Hampton Roads neighborhoods that fit best.
          </p>
        </div>
      </section>
      ...
      <section className="border-b border-gray-200 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 grid sm:grid-cols-3 gap-6 text-center">
          <div>
            ...
            <p className="mt-1 text-3xl font-bold text-blue-700">$3,054</p>
            <p className="text-xs text-gray-600">per month</p>
          </div>
          <div>
            <p className="text-xs text-gray-500 uppercase">Max home price</p>
            <p className="mt-1 text-3xl font-bold text-blue-700">~$489,000</p>
      ...
      <section className="bg-gray-50 border-y border-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
          ...
          <p className="mt-3 text-gray-700">Lieutenant Commander / Major. Senior O-grade with established family.</p>
          <p className="mt-4 text-gray-700">At $3,054/mo, an O-4 with dependents can support a home around $489K. This opens up newer construction in Harbour View (Suffolk), East Beach (Norfolk), and most VB neighborhoods.</p>
          <p className="mt-3 text-xs text-gray-500 italic">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Listings That Fit Your O-4 BAH</h2>
        <div className="mt-6 grid sm:grid-cols-2 gap-4">
          <Link href="/listings?max_price=489000&va_eligible=true" className="border border-gray-200 rounded-lg p-5 hover:border-blue-600">
            <p className="font-semibold text-gray-900">All listings under $489,000</p>
      ...
      <section className="bg-blue-700 text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <Link href="/contact?source=bah-o-4" className="bg-white text-blue-900 font-semibold px-5 py-3 rounded-lg hover:bg-blue-50 self-start">Get my pre-approval</Link>
        </div>
      </section>
