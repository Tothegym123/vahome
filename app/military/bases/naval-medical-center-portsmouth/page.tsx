...
const articleSchema = {
  ...
  "@type": "Article",
  headline: "Naval Medical Center Portsmouth (NMCP): Living, Housing & PCS Guide",
  description: "Comprehensive PCS guide for Naval Medical Center Portsmouth (NMCP) covering housing, BAH, neighborhoods, schools, and commute strategy in Hampton Roads.",
...
const placeSchema = {
  "@context": "https://schema.org",
  "@type": "Place",
  name: "Naval Medical Center Portsmouth (NMCP)",
...
export default function NavalMedicalCenterPortsmouthPage() {
  return (
    <main className="bg-white">
      ...
      <section className="bg-gradient-to-br from-slate-900 via-blue-950 to-blue-900 text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          <nav className="text-xs text-blue-200 mb-4">
            ...
            <span className="mx-2">/</span>
            <span className="text-white">NMCP</span>
          </nav>
          <h1 className="text-3xl sm:text-5xl font-bold leading-tight">Naval Medical Center Portsmouth (NMCP)</h1>
          <p className="mt-4 text-lg sm:text-xl text-blue-100 max-w-3xl">
            Largest Navy hospital on the East Coast and the oldest continuously operating military hospital in the United States. Provides full-spectrum medical care to active-duty, retirees, and dependents across the Mid-Atlantic. Hosts the Navy's largest medical training program.
          </p>
        </div>
      </section>
      ...
      <section className="border-b border-gray-200 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 grid sm:grid-cols-3 gap-6 text-center">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-700">Hospital corpsmen, Navy Medicine officers, dental and medical residents, dependents seeking proximity to MTF</p>
          </div>
        </div>
      </section>

      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Best Neighborhoods for NMCP Families</h2>
        <p className="mt-3 text-gray-700">Olde Towne Portsmouth, Park View, Cradock, Churchland (all in Portsmouth) plus Western Branch (Chesapeake side).</p>
      ...
      <section className="bg-gray-50 border-y border-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">BAH at NMCP</h2>
          <p className="mt-3 text-gray-700">
            NMCP falls inside the Norfolk Military Housing Area (MHA IZ325). BAH is identical to all other Hampton Roads installations including Naval Station Norfolk, NAS Oceana, JEB Little Creek-Fort Story, and Joint Base Langley-Eustis.
          </p>
      ...
      <section className="bg-blue-700 text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <p className="text-2xl font-bold">PCS-ing to NMCP?</p>
            <p className="text-blue-100 mt-1">I'll send a curated home list matched to your duty station, BAH, and school priorities.</p>
          </div>
          <Link href="/contact?source=naval-medical-center-portsmouth" className="bg-white text-blue-900 font-semibold px-5 py-3 rounded-lg hover:bg-blue-50 self-start">Get my list</Link>
        </div>
      </section>
