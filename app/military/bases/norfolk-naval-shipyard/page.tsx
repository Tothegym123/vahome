...
export const metadata: Metadata = {
  title: "Norfolk Naval Shipyard (NNSY): Living, Housing & PCS Guide | VaHome",
  description: "PCS guide for Norfolk Naval Shipyard (NNSY) in Portsmouth, VA. Top neighborhoods, BAH (Norfolk MHA), schools, commute, and VA-loan home search for Hampton Roads military families.",
  alternates: { canonical: "https://vahome.com/military/bases/norfolk-naval-shipyard/" },
  openGraph: { title: "NNSY PCS Guide", description: "Hampton Roads housing, BAH, and neighborhoods for NNSY families.", url: "https://vahome.com/military/bases/norfolk-naval-shipyard/", type: "article" },
};

const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Norfolk Naval Shipyard (NNSY): Living, Housing & PCS Guide",
  description: "Comprehensive PCS guide for Norfolk Naval Shipyard (NNSY) covering housing, BAH, neighborhoods, schools, and commute strategy in Hampton Roads.",
  datePublished: "2026-04-29",
  dateModified: "2026-04-29",
  author: { "@type": "Person", name: "Tom Milan", jobTitle: "Realtor" },
  publisher: { "@type": "Organization", name: "VaHome" },
  mainEntityOfPage: "https://vahome.com/military/bases/norfolk-naval-shipyard/",
};

const placeSchema = {
  "@context": "https://schema.org",
  "@type": "Place",
  name: "Norfolk Naval Shipyard (NNSY)",
  description: "U.S. Navy installation in Portsmouth, VA.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 4, name: "NNSY", item: "https://vahome.com/military/bases/norfolk-naval-shipyard/" },
  ],
};

export default function NorfolkNavalShipyardPage() {
  return (
    <main className="bg-white">
      ...
      <section className="bg-gradient-to-br from-slate-900 via-blue-950 to-blue-900 text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          <nav className="text-xs text-blue-200 mb-4">
            ...
            <span className="mx-2">/</span>
            <span className="text-white">NNSY</span>
          </nav>
          <h1 className="text-3xl sm:text-5xl font-bold leading-tight">Norfolk Naval Shipyard (NNSY)</h1>
          <p className="mt-4 text-lg sm:text-xl text-blue-100 max-w-3xl">
            Despite the name, NNSY is in Portsmouth and is the U.S. Navy's oldest continuously operating shipyard, dating to 1767. Specializes in nuclear-capable submarine and aircraft carrier maintenance, modernization, and repair. Major Navy industrial base with thousands of civilian and military shipyard workers.
          </p>
        </div>
      </section>
      ...
      <section className="border-b border-gray-200 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 grid sm:grid-cols-3 gap-6 text-center">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-gray-700">Shipyard sailors, nuclear technicians, mechanical / electrical ratings, Navy civilian engineers</p>
          </div>
        </div>
      </section>

      <section className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Best Neighborhoods for NNSY Families</h2>
        <p className="mt-3 text-gray-700">Cradock (closest), Olde Towne Portsmouth, Park View, Western Branch.</p>
      ...
      <section className="bg-gray-50 border-y border-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">BAH at NNSY</h2>
          <p className="mt-3 text-gray-700">
            NNSY falls inside the Norfolk Military Housing Area (MHA IZ325). BAH is identical to all other Hampton Roads installations including Naval Station Norfolk, NAS Oceana, JEB Little Creek-Fort Story, and Joint Base Langley-Eustis.
          </p>
      ...
      <section className="bg-blue-700 text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <p className="text-2xl font-bold">PCS-ing to NNSY?</p>
            <p className="text-blue-100 mt-1">I'll send a curated home list matched to your duty station, BAH, and school priorities.</p>
          </div>
          <Link href="/contact?source=norfolk-naval-shipyard" className="bg-white text-blue-900 font-semibold px-5 py-3 rounded-lg hover:bg-blue-50 self-start">Get my list</Link>
        </div>
      </section>

      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        <p className="text-xs text-gray-500">
          Sources: <a href="https://www.navsea.navy.mil/Home/Shipyards/Norfolk/" target="_blank" rel="noopener noreferrer" className="underline">NAVSEA â Norfolk Naval Shipyard</a>; <a href="https://www.travel.dod.mil/Allowances/Basic-Allowance-for-Housing/" target="_blank" rel="noopener noreferrer" className="underline">DTMO BAH</a>; <a href="https://www.reinmls.com/news" target="_blank" rel="noopener noreferrer" className="underline">REIN MLS</a>.
        </p>
      </section>
    </main>
  );
